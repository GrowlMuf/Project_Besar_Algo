...
void cikarang(){
	...
	{"26", 32}, 
  }; //data jarak stasiun line cikarang
...
void itung11(){
  ...
  cout << "Jarak perjalanan adalah " << total << " KM." << endl;
	...
	else if(total>25){cout<<"Harga Tiket Anda Rp"<<lebihjarak+4<<".000"<<endl;
	}
}
...
void itung21(){
  ...
  int originIndex, destinationIndex;
	 ...
	 for (int i = 0; i < 27; i++){
		if (stations[i].name == origin) {
      originIndex = i;}}
      int tl = sizeof(stations)/sizeof(int)/10;
      cout<<"jumlah stasiun "<<tl<<endl;garis();
	garis();
...
void itung31(){
  ...
  int originIndex, destinationIndex;
	 ...
	 for (int i = 0; i < 19; i++){
		if (stations[i].name == origin) {
      originIndex = i;}}
      int getArrayLength = sizeof(stations)/sizeof(int)/10;
      cout<<"jumlah stasiun "<<getArrayLength<<endl;garis();
garis();
